...
class AirApi {
    ...
    async listingSearch({
        ...
        format = 'for_explore_search_native',
        checkin,
        checkout,
        offset = 0,
        limit = 50,
        ...
        const options = this.buildOptions({
            uri: 'https://api.airbnb.com/v2/explore_tabs?query=Big Bear, CA&items_per_grid=50&toddlers=0&adults=0&infants=0&is_guided_search=true&version=1.4.8&section_offset=0&items_offset=0&screen_size=small&source=explore_tabs&_format=for_explore_search_native&metadata_only=false&refinement_paths[]=/homes&timezone=Europe/Lisbon&satori_version=1.1.0',
            headers: {
